    ...
    return (
      <>
        ...
        <Box sx={{display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', gap: '2em', mb: '2em'}}>
          <Typography variant="h4" textAlign='center' marginTop='24px' fontWeight='700' className={rubik.className}>
            Canoas contra a dengue
          </Typography>
          <Typography color='gray' textAlign='center' width='90%' className={rubik.className}>
